## Below are two functions (makeCacheMatrix, cacheSolve) that are used to create a special object 
...
## the inverse from the cache. Otherwise, it calculates the inverse of the data and sets the value of the 
